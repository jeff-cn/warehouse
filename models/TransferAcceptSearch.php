...
/**
 * TransferAcceptSearch represents the model behind the search form about `app\models\TransferAccept`.
 */
class TransferAcceptSearch extends TransferAccept
{
    /**
     * @inheritdoc
     */
