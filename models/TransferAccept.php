...
/**
 * This is the model class for table "transfer_accepts".
 *
 * @property integer $id
 ...
 * @property Box[] $Box
 */
class TransferAccept extends ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(TransferItem::className(), ['transfer_accept_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Box::className(), ['id' => 'box_id'])->viaTable('transfer_items', ['transfer_accept_id' => 'id']);
    }
}
